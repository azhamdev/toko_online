      ...
      <div class="ht-right">
        ...
        <div class="lan-selector">
          <select class="language_drop" name="countries" id="countries" style="width:300px;">
            <option value='yt' data-image="<?= base_url('././publicfashi-master/img/flag-1.jpg') ?>" data-imagecss="flag yt" data-title="English">English</option>
        ...
        <div class="top-social">
          ...
          <div>
            <img src="../fashi-master/img/flag-1.jpg">
          </div>
        </div>
      </div>
    </div>
